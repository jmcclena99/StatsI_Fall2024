...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=37, lastline=45]{PS01.r}	
	...
	\noindent Using the same sample, conduct the appropriate hypothesis test with $\alpha=0.05$.
		...
		\lstinputlisting[language=R, firstline=49, lastline=49]{PS01.r}	
...
\lstinputlisting[language=R, firstline=64, lastline=80]{PS01.r}	
...
\lstinputlisting[language=R, firstline=82, lastline=88]{PS01.r}	
...
\lstinputlisting[language=R, firstline=83, lastline=93]{PS01.r}	
